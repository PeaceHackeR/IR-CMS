                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        ...
                        <div class="heading-button">
                            <a href="01event_results_add.php"><button type="button" class="btn btn-addnew btn-rounded-xs"><i class="icon-btn-addnew position-left"></i><span class="hidden-xs">Add</span></button></a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                                    ...
                                    <table class="table table-hover tasks-list">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="td-year text-center">Quearter/Year</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01event_results_detail.php">การประชุมนักวิเคราะห์</a></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01event_results_detail.php">ประกาสผลประกอบการ</a></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01event_results_detail.php">Conference Call</a></td>
