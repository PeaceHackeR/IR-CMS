                        ...
                        <div class="col-lg-9 col-xs-12">
                            ...
                            <div class="content-group">
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <p class="text-center"><img src="assets-cms/images/upload/img_350x200.jpg" class="img-responsive"></p>
                                        </div>
                                    </div>
                                </div>
                                <p class="last-modified"><strong>Last Modified</strong> Aug 9, 2017 at 04.38 pm - by <a href="#">Admin</a></p>
                            ...
                            <div class="content-group">
                                <div class="heading-topic">
                                    ...
                                    <!-- App -->
                                    <?php include 'ssi/app-thai-thumbnail-view.php'; ?>
                                    <!-- /App -->
                                </div>
                                <div class="panel panel-flat">
                                    <div class="panel-body">
                            ...
                            <div class="content-group">
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <p>CGH was founded on 15th May 2014 as part of a restructuring plan initiated by Country Group Securities Public Company Limited (CGS) to create a dynamic investment holding company. CGH replaced CGS to become listed on the SET on 8th Jan 2015, with CGS as the core subsidiary </p>
                                            <p>At CGH, we aim to deliver superior returns to our investors by developing in-house experts to take an active management approach in all of our investments. We encourage our people to think differently to promote an innovative and entrepreneurial culture within our network.</p>
                                            <p>CGH was founded on 15th May 2014 as part of a restructuring plan initiated by Country Group Securities Public Company Limited (CGS) to create a dynamic investment holding company. CGH replaced CGS to become listed on the SET on 8th Jan 2015, with CGS as the core subsidiary </p>
                                            <p>At CGH, we aim to deliver superior returns to our investors by developing in-house experts to take an active management approach in all of our investments. We encourage our people to think differently to promote an innovative and entrepreneurial culture within our network.</p>
                                        </div>
                                    </div>
