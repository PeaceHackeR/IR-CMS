                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        ...
                        <div class="heading-button">
                            <a href="01news_prnews_add.php"><button type="button" class="btn btn-addnew btn-rounded-xs"><i class="icon-btn-addnew position-left"></i><span class="hidden-xs">Add</span></button></a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                                    ...
                                    <table class="table table-hover tasks-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01news_prnews_detail.php">ทีทีเอทุ่ม600ล.ปูพรมพิซซ่าฮัทขยาย100สาขา</a></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01news_prnews_detail.php">กลุ่มเดินเรือฟื้น</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-yes">Yes</span></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01news_prnews_detail.php">'TTA'สดใส ค่าระวางขาขึ้น</a></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01news_prnews_detail.php">TTA ธุรกิจเดินเรือ-ปุ๋ยรุ่ง ส่งซิกผลงานปี 60 โตแรง</a></td>
                                            ...
                                            <tr>
                                                <td class="td-date text-center"><span class="date">Aug 9, 2017</span></td>
                                                <td class="td-title"><a href="01news_prnews_detail.php">เคาะไป คุยไป</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                <td class="td-flag text-center">-</td>
                                                <td class="td-status text-center">
                                                    <span class="status">Edited by <a href="#">Admin</a></span><br>
