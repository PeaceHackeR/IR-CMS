                                    ...
                                    <table class="table table-hover tasks-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01shareholder_freefloat_detail-edit.php">ผู้ถือหุ้นรายย่อย (Duplicate)</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01shareholder_freefloat_detail.php">ผู้ถือหุ้นรายย่อย</a></td>
                                                <td class="td-asof text-center">Jun 24, 2017</td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                ...
                                                <td class="td-actions text-center">
                                                    <?php include 'ssi/app-actions-duplicate.php'; ?>
                                                </td>
                                            </tr>
                                            <tr>
