                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        ...
                        <div class="heading-button">
                            <a href="01news_corporate_add.php"><button type="button" class="btn btn-addnew btn-rounded-xs"><i class="icon-btn-addnew position-left"></i><span class="hidden-xs">Add</span></button></a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                                    ...
                                    <table class="table table-hover tasks-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01news_corporate_detail.php">คันทรี่ กรุ๊ป โฮลดิ้งส์และบริษัทหลักทรัพย์คันทรี่ กรุ๊ป ร่วมแสดงพลังวันต่อต้านคอร์รัปชันประจำปี 2560</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01news_corporate_detail.php">“คันทรี่ กรุ๊ป โฮลดิ้งส์” เดินหน้าขยายโอกาสทางการศึกษาอย่างยั่งยืน ลงพื้นที่พัฒนาความรู้</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-yes">Yes</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01news_corporate_detail.php">CGH ชวนผู้บริหารและพนักงานร่วมทำกิจกรรมเพื่อสังคม ปลูกจิตสำนึกรักษ์ทะเลไทย</a></td>
