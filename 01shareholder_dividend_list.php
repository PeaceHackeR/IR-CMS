                            ...
                            <div class="dataTables_wrapper">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover tasks-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="td-version text-center">4.2</td>
                                                <td class="td-title"><a href="01shareholder_dividend_detail-edit.php">การจ่ายเงินปันผล (Duplicate)</a></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-title"><a href="01shareholder_dividend_detail.php">การจ่ายเงินปันผล</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
