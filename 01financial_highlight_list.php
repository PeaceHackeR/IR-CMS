                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        ...
                        <div class="heading-button">
                            <a href="01financial_highlight_add.php"><button type="button" class="btn btn-addnew btn-rounded-xs"><i class="icon-btn-addnew position-left"></i><span class="hidden-xs">Add</span></button></a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                    ...
                    <div class="panel panel-flat">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="dataTables_wrapper">
                                ...
                                <!-- App -->
                                <?php include 'ssi/app-list-filter-set.php'; ?>
                                <!-- /app -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover tasks-list">
                                        <thead>
                                            <tr>
                                                <th class="td-version text-center">Version</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="td-version text-center">5</td>
                                                <td class="td-title"><a href="01financial_highlight_detail-edit.php">ข้อมูลสำคัญทางการเงิน (New)</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-yes">Yes</span></td>
                                                <td class="td-set text-center">-</td>
                                            ...
                                            <tr>
                                                <td class="td-version text-center">4.1</td>
                                                <td class="td-title"><a href="01financial_highlight_detail-dup.php">ข้อมูลสำคัญทางการเงิน (Duplicate)</a></td>
                                            ...
                                            <tr>
                                                <td class="td-version text-center">4</td>
                                                <td class="td-title"><a href="01financial_highlight_detail.php">ข้อมูลสำคัญทางการเงิน</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                ...
                                                <td class="td-actions text-center">
                                                    <?php include 'ssi/app-actions-link-duplicate.php'; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td-version text-center">3</td>
                                                <td class="td-title"><a href="01financial_highlight_detail.php">ข้อมูลสำคัญทางการเงิน</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                <td class="td-set text-center"><span class="label label-rounded label-sync">Synced</span><br>
                                                <span class="date">Jun 24, 2017</span><br>
                                            ...
                                            <tr>
                                                <td class="td-version text-center">2</td>
                                                <td class="td-title"><a href="01financial_highlight_detail.php">ข้อมูลสำคัญทางการเงิน</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                <td class="td-set text-center"><span class="label label-rounded label-sync">Synced</span><br>
                                                <span class="date">Jun 24, 2017</span><br>
                                            ...
                                            <tr>
                                                <td class="td-version text-center">1</td>
                                                <td class="td-title"><a href="01financial_highlight_detail.php">ข้อมูลสำคัญทางการเงิน</a></td>
                                                <td class="td-publish text-center"><span class="label label-rounded label-no">No</span></td>
                                                <td class="td-set text-center"><span class="label label-rounded label-sync">Synced</span><br>
                                                <span class="date">Jun 24, 2017</span><br>
