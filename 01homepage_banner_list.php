                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        ...
                        <div class="heading-button">
                            <a href="01homepage_banner_add.php"><button type="button" class="btn btn-addnew btn-rounded-xs"><i class="icon-btn-addnew position-left"></i><span class="hidden-xs">Add</span></button></a>
                        </div>
                    </div>
                </div>
                <!-- /page header -->
                                        ...
                                        <table class="table table-hover tasks-list">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="td-img text-center">
                                                        <div class="thumbnail-list rectangle">
                                                            <a href="assets-cms/images/upload/img_700x300.jpg" data-popup="lightbox">
                                                                <img src="assets-cms/images/upload/img_700x300.jpg" alt="">
                                                                <i class="icon-zoom-img"></i>
                                                            </a>
                                                        </div>
                                                    </td>
                                                    <td class="td-title"><a href="01homepage_banner_detail.php">Lorem Ipsum All 1</a></td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                    <td class="td-date text-center">-</td>
                                                    <td class="td-date text-center">-</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title"><a href="01homepage_banner_detail.php">Lorem Ipsum All 2</a></td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title"><a href="01homepage_banner_detail.php">Lorem Ipsum All 3</a></td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                    <td class="td-date text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title"><a href="01homepage_banner_detail.php">Lorem Ipsum All 4</a></td>
                                                    <td class="td-publish text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title"><a href="01homepage_banner_detail.php">Lorem Ipsum All 5</a></td>
                                                    <td class="td-publish text-center">
                                ...
                                <div class="dataTables_wrapper">
                                    <div class="datatable-header">
                                        <div class="dataTables_length">
                                            <a href="01homepage_banner_list.php"><button type="button" class="btn btn-cancel">Cancel</button></a>
                                        ...
                                        <table class="table table-hover tasks-list" id="sortable-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="td-title">Lorem Ipsum All 1</td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                    <td class="td-date text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title">Lorem Ipsum All 2</td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                    <td class="td-date text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-title">Lorem Ipsum All 3</td>
                                                    <td class="td-publish text-center">
                                                        <span class="label label-rounded label-yes">Yes</span>
                                                    </td>
                                                    <td class="td-date text-center">
